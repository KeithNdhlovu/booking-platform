    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="text-left m-t-30">
                <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="btn waves-effect waves-light btn-danger hidden-md-down"> Logout</a>
            </div>
        </nav>
