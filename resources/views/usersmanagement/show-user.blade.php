        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-block">
                    <center class="m-t-30"> <img src="{{ $user->profile_picture ? route('user.profile-picture', $user->id) : asset('images/faces-clipart/pic-1.png') }}" class="img-circle" width="150" height="150">
                        ...
                        <h6 class="card-subtitle">
                          ...
                          @elseif ($user->isAirportAdmin())
                              <span class="badge badge-primary">Airport Administrator</span>
                          @endif
                        </h6>
